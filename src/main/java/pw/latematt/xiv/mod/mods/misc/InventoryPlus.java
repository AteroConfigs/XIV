...
public class InventoryPlus extends Mod {
    ...
    public InventoryPlus() {
        ...
        sendPacketListener = new Listener<SendPacketEvent>() {
            ...
            public void onEventCalled(SendPacketEvent event) {
                event.setCancelled(event.getPacket() instanceof C0DPacketCloseWindow);
            }
        };
    ...
    public void onEnabled() {
        XIV.getInstance().getListenerManager().add(sendPacketListener, motionUpdateListener);
    }

    @Override
    public void onDisabled() {
        XIV.getInstance().getListenerManager().remove(sendPacketListener, motionUpdateListener);
    }
}
